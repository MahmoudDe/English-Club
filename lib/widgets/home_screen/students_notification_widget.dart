...
class StudentsNotificationWidget extends StatefulWidget {
  ...
  @override
  State<StudentsNotificationWidget> createState() =>
      _StudentsNotificationWidgetState();
}

class _StudentsNotificationWidgetState
    extends State<StudentsNotificationWidget> {
  List doneTasks = [];
  ...
  Future<void> getData() async {
    try {
      ...
      await Provider.of<HomeProvider>(context, listen: false)
          .getAllNotificationsForStudents(page: '0');
      setState(() {
        isLoading = false;
      });
